...
public class OreGeneration {
	...
	public static void setupOreGeneration()
	{
		if(OregenConfig.generate_overworld.get())
		{
			...
			{				
				biome.addFeature(Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE, new OreFeatureConfig(FillerBlockType.NATURAL_STONE, GurgModBlocks.orrin_essence_ore.getDefaultState(), OregenConfig.orrin_chance.get()), Placement.COUNT_RANGE, new CountRangeConfig(10, 20, 0, 100)));
				...
				biome.addFeature(Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE, new OreFeatureConfig(FillerBlockType.NATURAL_STONE, GurgModBlocks.gregory_essence_ore.getDefaultState(), OregenConfig.gregory_chance.get()), Placement.COUNT_RANGE, new CountRangeConfig(10, 20, 0, 100)));
				...
				biome.addFeature(Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE, new OreFeatureConfig(FillerBlockType.NATURAL_STONE, GurgModBlocks.keith_essence_ore.getDefaultState(), OregenConfig.keith_chance.get()), Placement.COUNT_RANGE, new CountRangeConfig(10, 20, 0, 100)));
				...
				biome.addFeature(Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE, new OreFeatureConfig(FillerBlockType.NATURAL_STONE, GurgModBlocks.leslie_essence_ore.getDefaultState(), OregenConfig.leslie_chance.get()), Placement.COUNT_RANGE, new CountRangeConfig(10, 20, 0, 100)));
				...
				biome.addFeature(Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE, new OreFeatureConfig(FillerBlockType.NATURAL_STONE, GurgModBlocks.franklin_essence_ore.getDefaultState(), OregenConfig.franklin_chance.get()), Placement.COUNT_RANGE, new CountRangeConfig(10, 20, 0, 100)));
